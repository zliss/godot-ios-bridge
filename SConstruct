...
if env["platform"] == "macos":
    library = env.SharedLibrary(
        "bin/lib/IOSBridgePlugin.{}.{}.framework/IOSBridgePlugin.{}.{}".format(
    ...
    if env["simulator"]:
        library = env.StaticLibrary(
            "bin/lib/IOSBridgePlugin.{}.{}.simulator.a".format(env["platform"], env["target"]),
            source=sources,
        )
    else:
        library = env.StaticLibrary(
            "bin/lib/IOSBridgePlugin.{}.{}.a".format(env["platform"], env["target"]),
            source=sources,
        )
else:
    library = env.SharedLibrary(
        "bin/lib/IOSBridgePlugin{}{}".format(env["suffix"], env["SHLIBSUFFIX"]),
        source=sources,
    )
